...
<body >
    ...
    <form action="<?=base_url().'resturant/Resturant/authenticate';?>" name="regform" id="regform" method="post">
      ...
      <div class="row mt-5">
          <div class="col-12 col-md-7 mb-4">
            <a href="<?=base_url().'resturant/Resturant/signup';?>" >Register if you don't have an account</a>
          </div>
